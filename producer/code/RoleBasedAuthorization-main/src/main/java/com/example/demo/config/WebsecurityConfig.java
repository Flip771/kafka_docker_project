...
public class WebsecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		.antMatchers(HttpMethod.POST,"/v1/users/create").hasAnyRole("ADMIN")
		.antMatchers(HttpMethod.POST,"/v1/users/register").permitAll()
		.antMatchers(HttpMethod.PUT,"/v1/users/update/{userId}").access("@userSecurity.hasUserId(authentication,#userId)")
